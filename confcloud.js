 ...
 script.onload = function() {
  ...
  script.onload = function() {
   ...
   script.onload = function() {
    ...
    var transmittersVariants = [{'variant' : 'Air', 'versions' : ['5.3.1']}, {'variant' : 'Pro3', 'versions' : ['5.3.1']}, {'variant' : 'Rack200 & Rack300', 'versions' : ['5.3.1']}, {'variant' : 'Pro460', 'versions' : ['3.5', '3.0']}, {'variant' : 'Rack400', 'versions' : ['3.5', '3.0']}];
