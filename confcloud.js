  ...
  loadScript('https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js', function() {
    ...
    loadScript('https://esouthers.github.io/infocenter-viewport/config.js', function() {
        ...
        loadScript('https://cdnjs.cloudflare.com/ajax/libs/aui/9.10.0/aui/aui-prototyping.min.js', function() {
          ...
          // Remove unused k15t storage
          localStorage.removeItem('pageTreeState');
      ...
      /*** SVG images ***/  
          ...
          var spinnerHTML = '<div class="HaiSpinner" data-theme="argon"><div class="spinner-border" style="animation: 1s linear 0s infinite normal none running spin;"></div></div>';
      ...
      //        }
            ...
            if (pageSearch) {
              ...
              function processSearchPage() { 
                ...
                $('.noResults').after('<div class="searchSpinner" style="display:none;">' + spinnerHTML + '</div>');
      ...
      */
      ...
      //          $('#custom-search-form .input.vp-search-input__input').tooltip('destroy');
            ...
            function doSearch(str, searchAllVersions, searchAllProducts) {
              ...
              var searchURL = '/__search?l=en&start=0&ol=false&q=' + searchTerm;
              searchURL += formGet('s', true) + formGet('v', true) + formGet('va', true);
              $.get(searchURL + '&max=100', function(data, status, jqXHR) {
                $('#suggestionList li:not(.searchSpinner)').remove();
                var numResults = data.total;
                if (numResults > 0) {
                  $(data.hits).each(function(i,val){
                  ...
                  let searchPageLink = '/search.html?' + searchURL.split('?')[1] + '&max=10';
