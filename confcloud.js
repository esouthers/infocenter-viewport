...
//*****************************
    ...
    function addCustomSearch() {
      ...
      function doSearch(str, searchAllVersions, searchAllProducts) {
        ...
        searchURL += paramsGet('s', true) + paramsGet('v', true) + paramsGet('va', true);
        formGet(name, prefix) {
          if (prefix) { return $('#custom-search-form [name="blah"]').length == 0 ? '' : '&' + name + '=' + $('#custom-search-form [name="' + name + '"]').attr('value'); }
          else {        return $('#custom-search-form [name="blah"]').length == 0 ? '' : $('#custom-search-form [name="' + name + '"]').attr('value'); }
        }
