...
scrollHelpCenter.collection.members = scrollHelpCenter.collection.members.sort( compare );
  ...
  */
  ...
  //              if ($(this).attr('href').indexOf(path) >= 0) { 
          ...
          let userprefs = '<section role="dialog" id="userprefs" data-aui-modal="true" class="hai-dialog aui-dialog2 card" aria-hidden="true" style="display:none"><header class="aui-dialog2-header card-header"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 48 48" class="HaiIcon"><path d="M10,22.26V4c0-1.1-.9-2-2-2s-2,.9-2,2V22.26c-3.44,.89-6,4.02-6,7.74s2.56,6.85,6,7.74v6.26c0,1.1,.9,2,2,2s2-.9,2-2v-6.26c3.44-.89,6-4.02,6-7.74s-2.56-6.85-6-7.74Zm-2,11.74c-2.21,0-4-1.79-4-4s1.79-4,4-4,4,1.79,4,4-1.79,4-4,4Z"></path><path d="M32,16c0-3.72-2.56-6.85-6-7.74V4c0-1.1-.9-2-2-2s-2,.9-2,2v4.26c-3.44,.89-6,4.02-6,7.74s2.56,6.85,6,7.74v20.26c0,1.1,.9,2,2,2s2-.9,2-2V23.74c3.44-.89,6-4.02,6-7.74Zm-8,4c-2.21,0-4-1.79-4-4s1.79-4,4-4,4,1.79,4,4-1.79,4-4,4Z"></path><path d="M48,34c0-3.72-2.56-6.85-6-7.74V4c0-1.1-.9-2-2-2s-2,.9-2,2V26.26c-3.44,.89-6,4.02-6,7.74s2.56,6.85,6,7.74v2.26c0,1.1,.9,2,2,2s2-.9,2-2v-2.26c3.44-.89,6-4.02,6-7.74Zm-8,4c-2.21,0-4-1.79-4-4s1.79-4,4-4,4,1.79,4,4-1.79,4-4,4Z"></path></svg><h2 class="haiui-heading-03-book">User Preferences</h2><a class="card-close"><span class="aui-icon aui-icon-small hai-icon-download-close">Close</span></a></header><div class="card-body haiui-body-02"><form class="brightnessContrast"><div class="control-container"><label for="brightnessInput" class="slidertext" id="brightnessRangeLabel">Brightness</label><div class="slidecontainer"><input id="brightnessInput" type="range" min="70" max="130" value="100" class="control slider brightnessRange" aria-labelledby="brightnessRangeLabel"></div></div><div class="control-container"><label for="contrastInput" class="slidertext" id="contrastRangeLabel">Contrast</label><div class="slidecontainer"><input id="contrastInput" type="range" min="70" max="130" value="100" class="control slider contrastRange" aria-labelledby="contrastRangeLabel"></div></div></form><div class="control-container control-borderbottom"><button class="secondary btn-sm resetBCButton">Reset</button><p class="cookieDisabledNote"><strong>Note:</strong> Cookies are disabled. Therefore, these settings to do not persist when browsing.</p></div><div class="cookieContainer control-container hidden"><label class="control-label">Cookies/Browser Storage</label><div class="combine-items align-left"><button class="secondary btn-sm clearCookies">Clear</button><div class="clearCookiesNote"><strong>Note:</strong> <a href="/Home/privacy-and-cookies">View list</a> of cookies/browser storage used.</div></div></div></div><footer class="card-footer"><div class=""><button class="primary dialog-close-button">Close</button></div></footer></section>';
