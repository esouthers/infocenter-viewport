...
//*****************************
    ...
    function addCustomSearch() {
      ...
      let hiddenInputs = '<input type="hidden" name="l" value="en"><input type="hidden" name="max" value="10"><input type="hidden" name="ol" value=""><input type="hidden" name="q" value=""><input type="hidden" name="s" value=""><input type="hidden" name="start" value="0">';
