function confCloudJS() { 
  ...
  //            let bgImgSrc = $('footer img').attr('src');
            ...
            $('vp-article-pagination').each(function() {
              ...
              style.innerHTML = 'a { max-width: unset; } a[rel*="next"] {margin-inline-start: unset;} .description, a:is(:hover, :focus-visible) .description { color: var(--haiui-blue-03); } a:is(:hover, :focus-visible, :active) .cta, .cta {color: var(--haiui-blue-03); background-color: transparent;}';
