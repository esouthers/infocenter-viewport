...
*/
      ...
      function addPDFButtons() {
        $('.pdf-export-button').each(function() {
          let templateLetter = $('.templateLetter', this).attr('title');
          let templateA4 = $('.templateA4', this).attr('title');
          $(this).after('<button class="primary pdf-button" data-templateLetter="' + templateLetter + '" data-templateA4="' + templateA4 + '">Export to PDF</button>');
        });
...
//        addEventTrackingUserPrefs("Clear cookies", window.location.href);
    ...
    function pdfButtonEventListeners() {
      ...
      $('#pdf-dialog .dialog-start-button').on('click', function(e) {
        ...
        var pdfTemplateID = $('input[name="paperSize"]:checked').val() == 'a4' ? pdfTemplateIDA4 : pdfTemplateIDLetter;
        $.ajax({
