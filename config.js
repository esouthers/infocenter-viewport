var hvConfig = {
  ...
  // This is used for users who have bookmarks of our old Server site. The URL construction was HMP3.8 versus now which is HMP/3.8. If the redirect value doesn't exist, then the same value is implied.
  productRedirectJSON: {
                          "Command360": {},
                          "CDVR":       {},
